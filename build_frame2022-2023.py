...
df2022 = pd.read_excel('./data3/es/2022.xlsx')
...
# %%
df = df_2023[['code_discription', 'address_raw', 'data_short', 'cost']].copy()
df2 = df2022.copy()
...
df2['data_short'] = pd.to_datetime(df2['data_short'], format='%Y-%m-%d')
...
# %%
df['es_code_int'] = df.apply(get_type_of_es, axis=1)
df2['es_code_int'] = df2.apply(get_type_of_es, axis=1)
df2 = clean_address(df2, 'address_raw', 'test')
...
# %%
mrg_df.to_excel('./data/dataset2022-2023.xlsx', index=False)
